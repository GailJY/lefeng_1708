  ...
  //接收URL中的参数
	...
	$.each(res.shop, function(idx,item) {
		    ...
		    if(id == item.id){
		     ...
		     +"</h1><p>两件起售，韩方成分，掀起健康染发新风潮（新旧包装随机发货）</p></dd><dt><div class='dity-pic' id='dity-pic'><img src="+item.imgurl2+"><div class='dity-tags'><span>染发</span><span>中药</span><div class='dity-share'></div></div><div class='dity'><div class='dity-cont'><div class='dity-price-c'><span class='dity-title'>价格</span><span><b class='lighten'>￥</b><strong>"+item.price
